...
public class Utils {
	...
	public static String predictNext_ANN(String code){
	...
	public static String predictNext_Bayes(String code){
	...
	public static String predictNext_Indicator(String code){
		// TODO Auto-generated method stub
		String temp = "";
		try {
